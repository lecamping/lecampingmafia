...
class StartupControllerTest extends WebTestCase
{    /**
    ...
    public function testAccess()
    {
        ...
        $crawler = $client->request('GET', '/admin/startup/');
    ...
    public function testCompleteScenario()
    {
        ...
        $fields = array();
        $cl = $this->em->getClassMetadata('SmiirlAdminBundle:Startup');
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'lcm_adminbundle_startuptype'  => $fields,
        ));
